...
namespace MultiLanguageApplication.Models
{
    public class Registration
    {
        ...
        [RegularExpression("^([0-9a-zA-Z]([+][0-9a-zA-Z]+)*)+@(([0-9a-zA-Z][-w]*[0-9a-zA-Z]*.)+[a-zA-Z0-9]{2,3})$", ErrorMessageResourceType = typeof(Resource), ErrorMessageResourceName = "EmailInvalid")]
        public string Email
        {
            get;
            set;
